       ...
       <div className='w-11/12 mx-auto p-4'>
        ...
        <div className='flex flex-wrap justify-evenly'>
          <img
            ...
            className="w-48 h-48 md:w-64 md:h-64 object-cover mb-6 rounded-full border-4 border-blue-500"
          />
          <img
            src={studyimg}
            alt="Study Image"
          ...
          <img
            src={logo1}
            alt="TechSpark Logo"
            className="hidden md:block w-48 h-48 md:w-64 md:h-64 object-cover mb-6 rounded-full border-4 border-blue-500"
          />
        </div>
